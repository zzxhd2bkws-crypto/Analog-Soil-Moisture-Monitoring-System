...
As the **Lead Analog Designer** for the Sensing & Alert subsystem, I was responsible for:
- **Analog Signal Conditioning:** Translating physical soil parameters into stable voltage levels.
- **Alarm Generation:** Designing a custom analog oscillator to provide acoustic feedback.
